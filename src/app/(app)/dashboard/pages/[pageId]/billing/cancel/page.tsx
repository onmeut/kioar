    ...
    <div className="mx-auto w-full max-w-2xl space-y-6 px-4 py-6 sm:py-10">
      <div className="flex items-center gap-2 text-xs text-zinc-500">
        <Button
          variant="ghost"
          size="sm"
          render={<Link href={backHref} className="-ms-2 h-8 gap-1 px-2" />}
        >
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-500">
              {alreadyCancelled
                ...
                : "اشتراک شما تا پایان دوره‌ی فعلی فعال می‌ماند و سپس لغو می‌شود."}
            </p>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <ul className="space-y-2 rounded-xl bg-zinc-50 p-4 text-[13px] leading-7 text-zinc-700">
            <li>
            ...
            <li>
              ...
              صفحه به پلن رایگان منتقل می‌شود و امکانات پولی به‌صورت قفل‌شده
              نمایش داده می‌شوند (بدون حذف اطلاعات).
            </li>
            <li>
              <span className="font-semibold text-zinc-800">قابل بازگشت:</span>{" "}
              تا پیش از پایان دوره می‌توانید لغو را خنثی کنید و اشتراک شما به
              همان شکل ادامه می‌یابد.
            </li>
            {periodEndLabel ? (
              <li>
                <span className="font-semibold text-zinc-800">
