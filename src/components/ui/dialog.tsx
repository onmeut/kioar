...
function DialogPortal({ container, ...props }: DialogPrimitive.Portal.Props) {
  // When rendered inside the dashboard live-preview phone mockup, portal into
  // the phone frame so backdrops/popups are scoped to the mockup. Fall back to
  // the default (document.body) outside the mockup.
