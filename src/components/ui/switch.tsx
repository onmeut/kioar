  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block h-5 w-5 rounded-full bg-background ring-0 transition-transform data-checked:translate-x-5 data-unchecked:translate-x-0 rtl:data-checked:-translate-x-5 rtl:data-unchecked:translate-x-0"
      />
    </SwitchPrimitive.Root>
  );
}
